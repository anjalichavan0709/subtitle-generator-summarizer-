...
| Final ZIP folder | Pending | ZIP will exclude generated WAV files to stay under the LMS upload limit. |
...
- Generated WAV audio files are available locally but excluded from the LMS ZIP because the platform upload limit is under 100 MB. The audio files can be regenerated by running the pipeline.
